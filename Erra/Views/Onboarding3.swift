...
import CoreData
 ...
 struct Onboarding3: View {
     ...
     @ObservedObject private var viewModel = Onboarding3ViewModel()
                             ...
                             if let user = Auth.auth().currentUser {
                                 ...
                                 viewModelAddress.AddressFunc(forUser: uid) { addressSuccess in
                                     if addressSuccess {
                                         ...
                                         viewModel.CoreDataVM2.updateOnboardingStatus(forUser: uid)
...
final class AddressViewModel: ObservableObject {
    ...
    func AddressFunc(forUser uid: String, completion: @escaping (Bool) -> Void) {
        guard !primary.isEmpty, !city.isEmpty, !country.isEmpty else {
...
@StateObject var CoreDataVM2 = CoreDataVM(managedObjectContext: PersistenceController.shared.container.viewContext)
}
